...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        __**Useful links**__
        [Dashboard](http://dash.pepebot.info/) | [Invite Pepe](https://discord.com/oauth2/authorize?client_id=870055161123450891&permissions=8&scope=bot%20applications.commands) | [Support Server](https://discord.gg/5A7ScUVk) | [Vote](https://discordbotlist.com/bots/pepe-bot-4882)
        `)
        emb.setFooter("Pepe Discord Bot\nMade by Prime(aka Johann)", client.user.displayAvatarURL({ dynamic: true }))
        emb.setTimestamp(new Date())


        interaction.reply({ components: [row, row2], embeds: [emb] })
